                    ...
                    <div class="col-10">
                        <ul class="navegador nav nav-justified">
                            <li class="nav-item py-3">
                                <a class="nav-link text-decoration-none link-light" href="#!/">Inicio</a>
                            </li>
                            <li class="nav-item py-3">
                                <a class="nav-link text-decoration-none link-light" href="#!carta">La Carta</a>
                            </li>
                            <li class="nav-item py-3">
                                <a class="nav-link text-decoration-none link-light" href="#!donde">Donde</a>
                            </li>
